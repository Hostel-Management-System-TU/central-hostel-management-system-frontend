      ...
      >
        ...
        <div className="hidden lg:block relative overflow-hidden">
          ...
          <div className="relative px-6 py-8">
            ...
            <p className="text-indigo-100 text-xs font-medium tracking-widest uppercase mt-1">
        ...
        <div className="p-4 border-t border-slate-100 bg-slate-50/50">
          <div className="flex items-center gap-3 p-3 rounded-xl bg-white border border-slate-100 shadow-sm">
            <div className="relative">
              <UserAvatar className="w-10 h-10 rounded-full ring-2 ring-indigo-100" />
